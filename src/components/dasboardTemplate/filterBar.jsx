...
const FilterBar = () => {
  ...
  return (
    <div className="p-7 rounded-md flex flex-col text-xs gap-2">
      ...
      <div className="flex flex-col gap-2 w-full">
        <label className="font-semibold">Urutkan berdasarkan</label>
        <select
          value={sortOption}
      ...
      <div className="flex flex-col gap-2 w-full">
        <label className="font-semibold text-sm">Filter berdasarkan</label>
        <select
          value={filterOption}
          onChange={(e) => setFilterOption(e.target.value)}
          className="w-full py-1 px-4 rounded-md bg-secondary-blue text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
          <option value="Pilih Koleksi text-sm">Pilih Koleksi</option>
