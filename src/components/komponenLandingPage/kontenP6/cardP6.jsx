...
const CardP6 = ({ description }) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-5 md:me-4">
      <div className="flex relative w-full md:w-[500px]">
        <img
        ...
        />
        <div className="lg:flex flex-col hidden justify-start items-end absolute -top-5 -right-12 gap-3">
          <div className="bg-secondary-blue w-14 h-3"></div>
          <div className="bg-secondary-blue w-10 h-3"></div>
        </div>
      </div>
      <div className="text-white bg-secondary-blue bg-opacity-10 border-solid border-2 border-primary-blue font-medium rounded-lg text-sm w-full md:w-[500px] px-5 md:px-10 py-5 text-start">
