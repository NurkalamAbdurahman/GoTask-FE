...
const DasboardMember = () => {
  ...
  const showProfileModal = (member) => {
    Swal.fire({
      ...
      html: `
        <div class="flex flex-col items-center p-6">
          ...
          <div class="w-full text-left text-sm space-y-2">
            <p><span class="font-semibold text-white">Divisi:</span> <span class="text-gray-400">${member.division || "Belum diatur"}</span></p>
            <p><span class="font-semibold text-white">Kelas:</span> <span class="text-gray-400">${member.class || "Belum diatur"}</span></p>
            <p><span class="font-semibold text-white">Email:</span> <span class="text-gray-400">${member.email || "Tidak tersedia"}</span></p>
          </div>
      ...
      didOpen: () => {
        document.getElementById("closeProfileModal").addEventListener("click", () => Swal.close());
      },
  ...
  return (
    <div className="lg:h-screen overflow-hidden w-full 2xl:text-lg p-3 flex flex-col gap-2 py-5">
      <div className="flex w-full flex-col-reverse lg:flex-row relative justify-center items-center gap-2">
        <div className="w-full lg:w-1/2">
          <div className="inverted-member text-xs flex flex-col items-start justify-center gap-2 p-4">
            ...
            <p className="text-sm 2xl:text-base leading-relaxed text-gray-400">
      ...
      <div className="w-full p-4 mt-5">
        <h1 className="text-base 2xl:text-lg font-bold mb-4">Workspace Member</h1>
        <p className="text-sm 2xl:text-base text-gray-400 mb-4 leading-relaxed">
        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-4">
            <input
              ...
              className="w-full px-5 py-2 text-sm 2xl:text-base border border-primary-blue bg-secondary-blue bg-opacity-10 rounded-lg"
            />
